...
class SelectCategoryService1Dialog: DialogFragment() {

    private var _binding: DialogSelectCategoryService1Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogSelectCategoryService1Binding.inflate(inflater, container, false)
