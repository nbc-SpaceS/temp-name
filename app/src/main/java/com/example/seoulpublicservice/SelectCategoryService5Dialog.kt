...
class SelectCategoryService5Dialog: DialogFragment() {

    private var _binding: DialogSelectCategoryService5Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogSelectCategoryService5Binding.inflate(inflater, container, false)
