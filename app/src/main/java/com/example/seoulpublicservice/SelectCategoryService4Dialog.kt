...
class SelectCategoryService4Dialog: DialogFragment() {

    private var _binding: DialogSelectCategoryService4Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogSelectCategoryService4Binding.inflate(inflater, container, false)
