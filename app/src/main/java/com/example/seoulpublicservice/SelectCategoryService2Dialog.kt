...
class SelectCategoryService2Dialog: DialogFragment() {

    private var _binding: DialogSelectCategoryService2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogSelectCategoryService2Binding.inflate(inflater, container, false)
